...
setSelected - сохранение товара для подробного отображения;
getSelected - получение товара для подробного отображения.
resetSelected - сбрасывание выборанного товара для подробного отобрадения;


#### Класс Cart
Класс отвечает за хранение массива выбранных для покупки товаров.
...
#### Класс Buyer
Класс отвечет за хранение данных покупателя (вид оплаты, адреc, телефон, email), которые тот должен указать при оформлении, также проводит проверку валидности этих данных.
